...
Seguro.prototype.cotizarSeguro = function()  {
   ...
   // Cada year que la diferencia es mayor el costo va  areducirse un 3%
   cantidad -= ((diferencia * 3) * cantidad ) / 100;

   /*
   Si el seguro es basico se multiplica por un 30% mas 
   Si el seguro es compelto se mutiplica por un 50% mas
...
// Llena las opciones de los year
...
document.addEventListener('DOMContentLoaded', () => {
    ui.llenarOpciones(); // Llena el select con los year...
...
function cotizarSeguro(e) {
    ...
    // Ocultar las costizaciones previas
